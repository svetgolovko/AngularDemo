(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClientFormComponent = /** @class */ (function () {
                function ClientFormComponent(route, router, clientService) {
                    this.route = route;
                    this.router = router;
                ...
                ClientFormComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.clientService.save(this.client).subscribe(function (result) { return _this.gotoClientList(); });
                };
                ClientFormComponent.prototype.gotoClientList = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductFormComponent = /** @class */ (function () {
                function ProductFormComponent(route, router, productService) {
                    this.route = route;
                    this.router = router;
                ...
                ProductFormComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.productService.save(this.product).subscribe(function (result) { return _this.gotoProductList(); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProductListComponent = /** @class */ (function () {
                ...
                ProductListComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.productService.findAll().subscribe(function (data) {
                        _this.products = data;
                    });
                };
